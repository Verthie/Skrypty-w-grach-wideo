function love.load()
    love.graphics.setBackgroundColor(28/255, 28/255, 28/255)
...
function love.update(dt)
    ...
    local isFastFall = love.keyboard.isDown('down')
    local currentLimit = isFastFall and fastTimerLimit or timerLimit

    if timer >= currentLimit then
        timer = 0
...
function love.draw()
    local function drawBlock(block, x, y)
        local colors = {
            [' '] = {146/255, 131/255, 116/255},
            i = {131/255, 165/255, 152/255},
            j = {142/255, 192/255, 124/255},
            l = {235/255, 128/255, 25/255},
            o = {250/255, 189/255, 47/255},
            s = {184/255, 187/255, 38/255},
            t = {211/255, 134/255, 155/255},
            z = {251/255, 73/255, 52/255},
        }
    ...
    local gridPixelWidth  = gridXCount * blockSize
    local gridPixelHeight = gridYCount * blockSize
    local windowWidth, windowHeight = love.graphics.getDimensions()

    love.graphics.push()
    love.graphics.translate(
        math.floor((windowWidth  - gridPixelWidth)  / 2),
        math.floor((windowHeight - gridPixelHeight) / 2)
    )
